...
lycanroc: {
	...
	girafarig: {
		...
		types: ["Ghost", "Psychic"],
		baseStats: {hp: 95, atk: 130, def: 75, spa: 85, spd: 80, spe: 105},
		abilities: {0: "Simple", 1: "Sheer Force", H: "Sap Sipper"},
	},
	chimecho: {
		inherit: true,
		types: ["Ghost", "Normal"],
		baseStats: {hp: 95, atk: 50, def: 90, spa: 95, spd: 140, spe: 100},
		abilities: {0: "Magic Guard", 1: "Natural Care", H: "Triage"},
	},
	bronzong: {
		inherit: true,
		types: ["Steel"],
		baseStats: {hp: 80, atk: 80, def: 145, spa: 100, spd: 145, spe: 20},
		abilities: {0: "Filter", 1: "Magnet Pull", H: "Berserk"},
	},
	armaldo: {
		inherit: true,
		types: ["Steel", "Rock"],
		baseStats: {hp: 75, atk: 135, def: 90, spa: 60, spd: 80, spe: 130},
		abilities: {0: "Rock Head", H: "Steelworker"},
	},
	garbodor: {
		inherit: true,
		types: ["Steel", "Poison"],
		baseStats: {hp: 100, atk: 130, def: 107, spa: 40, spd: 107, spe: 86},
		abilities: {0: "Levitate", 1: "Oblivious", H: "Defiant"},
	},
	   cresselia: {
		inherit: true,
		types: ["Fairy"],
		baseStats: {hp: 120, atk: 50, def: 140, spa: 95, spd: 105, spe: 60},
		abilities: {0: "Serene Grace"},
	},
		goodra: {
		inherit: true,
		types: ["Fairy", "Dragon"],
		baseStats: {hp: 76, atk: 38, def: 114, spa: 133, spd: 152, spe: 57},
		abilities: {0: "Gooey", 1: "Tangling Hair", H: "Thick Fat"},
	},
		nidoqueen: {
		inherit: true,
		types: ["Fairy", "Ground"],
		baseStats: {hp: 110, atk: 65, def: 115, spa: 95, spd: 105, spe: 75},
		abilities: {0: "Mold Breaker", 1: "Multiscale", H: "Sheer Force"},
	},
		nidoking: {
		inherit: true,
		types: ["Poison"],
		baseStats: {hp: 90, atk: 105, def: 80, spa: 105, spd: 80, spe: 105},
		abilities: {0: "Dazzling", 1: "No Guard", H: "Sheer Force"},
	},
		mukalola: {
		inherit: true,
		types: ["Poison", "Dark"],
		baseStats: {hp: 105, atk: 125, def: 80, spa: 65, spd: 130, spe: 65},
		abilities: {0: "Poison Touch", 1: "Moxie", H: "Power of Alchemy"},
	},
		muhsarana: {
		inherit: true,
		types: ["Poison", "Psychic"],
		baseStats: {hp: 130, atk: 50, def: 110, spa: 110, spd: 1100, spe: 60},
		abilities: {0: "Levitate", 1: "Unawate", H: "Regenerator"},
	},
		snorlax: {
		inherit: true,
		types: ["Normal"],
		baseStats: {hp: 160, atk: 130, def: 70, spa: 30, spd: 130, spe: 50},
		abilities: {0: "Poison Heal", 1: "Thick Fat", H: "Sheer Force"},
	},
		heatmor: {
		inherit: true,
		types: ["Normal", "Fire"],
		baseStats: {hp: 80, atk: 125, def: 80, spa: 80, spd: 80, spe: 125},
		abilities: {0: "Flash Fire", 1: "Moxie", H: "Skill Link"},
	},
		zangoose: {
		inherit: true,
		types: ["Normal", "Steel"],
		baseStats: {hp: 90, atk: 130, def: 80, spa: 60, spd: 80, spe: 130},
		abilities: {0: "Defiant", 1: "Guts", H: "Tough Claws"},
	},
		druddigon: {
		inherit: true,
		types: ["Dragon"],
		baseStats: {hp: 107, atk: 125, def: 100, spa: 60, spd: 100, spe: 78},
		abilities: {0: "Rough Skin", 1: "Sheer Force", H: "Mold Breaker"},
	},
		seviper: {
		inherit: true,
		types: ["Poison"],
		baseStats: {hp: 90, atk: 125, def: 100, spa: 60, spd: 100, spe: 95},
		abilities: {0: "Strong Jaws", 1: "Shed Skin", H: "Infiltrator"},
	},
		lapras: {
		inherit: true,
		types: ["Dragon", "Ice"],
		baseStats: {hp: 130, atk: 105, def: 80, spa: 110, spd: 75, spe: 70},
		abilities: {0: "Slush Rush", 1: "Multiscale", H: "Refrigerate"},
	},
		wishiwashi: {
		inherit: true,
		types: ["Water"],
		baseStats: {hp: 80, atk: 130, def: 100, spa: 140, spd: 100, spe: 20},
		abilities: {0: "Schooling"},
	},
		araquanid: {
		inherit: true,
		types: ["Water", "Bug"],
		baseStats: {hp: 100, atk: 90, def: 120, spa: 50, spd: 172, spe: 38},
		abilities: {0: "Water Bubble", 1: "Drizzle", H: "Regenerator"},
	},
		clawitzer: {
		inherit: true,
		types: ["Water", "Fire"],
		baseStats: {hp: 81, atk: 73, def: 88, spa: 130, spd: 89, spe: 109},
		abilities: {0: "No Guard", 1: "Sniper", H: "Dazzling"},
	},
  };
